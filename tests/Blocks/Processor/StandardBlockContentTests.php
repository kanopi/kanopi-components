...
namespace Blocks\Processor;

use Kanopi\Components\Blocks\Processor\StandardBlockContent;
...
class StandardBlockContentTests extends TestCase {
	...
	public function standardTestProcessor(): StandardBlockContent {
		...
		$listItems = new \Kanopi\Components\Blocks\Model\Blocks\ListItem();
		$paragraph = new \Kanopi\Components\Blocks\Model\Blocks\Paragraph();

		$transforms = Arrays::from(
			[
				'paragraph'     => $paragraph,
				'blockquote'    => new \Kanopi\Components\Blocks\Model\Blocks\BlockQuote(),
				'orderedList'   => new \Kanopi\Components\Blocks\Model\Blocks\OrderedList(),
				'unorderedList' => new \Kanopi\Components\Blocks\Model\Blocks\UnorderedList(),
				'headingOne'    => new \Kanopi\Components\Blocks\Model\Blocks\HeadingOne(),
				'headingTwo'    => new \Kanopi\Components\Blocks\Model\Blocks\HeadingTwo(),
				'headingThree'  => new \Kanopi\Components\Blocks\Model\Blocks\HeadingThree(),
				'headingFour'   => new \Kanopi\Components\Blocks\Model\Blocks\HeadingFour(),
				'headingFive'   => new \Kanopi\Components\Blocks\Model\Blocks\HeadingFive(),
				'headingSix'    => new \Kanopi\Components\Blocks\Model\Blocks\HeadingSix(),
			]
		);
